...
import static com.umarappdel.earningapk.model.Veriables.Paypal_AccountURL;
...
public class PaypalFragment extends Fragment {
    ...
    private void loadImage() {
        Glide.with(PaypalFragment.this)
    ...
    private void init(View view) {
        ...
        circleImageView = view.findViewById(R.id.Paypal);
    ...
    private void sendWithdrawRequest(String name, String phone, int amount) {
        ...
        map.put("image", Paypal_AccountURL);
