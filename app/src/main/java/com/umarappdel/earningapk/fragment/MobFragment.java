...
import static com.umarappdel.earningapk.model.Veriables.Easypaisa;
...
public class MobFragment extends Fragment {
    ...
    private void init(View view) {
        ...
        circleImageView = view.findViewById(R.id.Easypaisa);
