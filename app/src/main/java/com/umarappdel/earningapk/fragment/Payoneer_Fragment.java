...
import static com.umarappdel.earningapk.model.Veriables.Payoneer_Account;
import static com.umarappdel.earningapk.model.Veriables.Payoneer_ImageURl;

public class Payoneer_Fragment extends Fragment {
    ...
    private void loadImage() {
        ...
        Glide.with(Payoneer_Fragment.this)
    ...
    private void init(View view) {
        ...
        circleImageView = view.findViewById(R.id.Payoneer);
    ...
    private void sendWithdrawRequest(String name, String phone, int amount) {
        ...
        map.put("image", Payoneer_Account);
